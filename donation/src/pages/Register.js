    ...
    <>
      ...
      <div className="register-page">
        ...
        <form onSubmit={handleSubmit} className="register-form">
          ...
          <input
            type="text"
            name="phone_number" // Changed from phoneNumber to phone_number
            className="input-field"
          ...
          <p>
            <Link to="/Login.js">Already have an account? Login</Link>
          </p>
          <p>
            <Link to="/DistributorRegistrationForm.jsx">Register as a Distributor</Link>
          </p>
        </form>
      </div>
    </>
